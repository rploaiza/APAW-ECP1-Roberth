...
public class BuilderDepartmentTest {
	...
	@Test
	public void testDepartmentContainsNull() {
	...
	public void testBuilderDepartmentControl() {
		...
		Department department = new BuilderDepartment(1L, "TICs").center("Informatica").strategic(true)
				.employee(employee1).employee(employee2).build();
